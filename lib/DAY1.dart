              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "\n \n \t1. Sandwich selai kacang  \n \t    (Roti tawar dengan tambahan  \n \t    selai kacang di atasnya)",
                      style: TextStyle(
                          fontSize: 25,
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "\n \n \t1. Sandwich Dengan Telur \n \t(Roti tawar dengan telur ayam)",
                      style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.normal,
          ...
          Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/saladalpukat.jpeg"),
                  ),
                ),
              ),
              Row(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "\n \n \t1. Salad Tuna dan Alpukat \n \t    (Campuran salad ikan tuna  \n \t    dengan alpukat)",
                      style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.normal,
                          color: Color.fromARGB(255, 238, 237, 234)),
