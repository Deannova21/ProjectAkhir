...
class DAY3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("HARI KE-3", style: TextStyle(fontFamily: "Nunito"),),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/sandwichbutter.jpg"),
                  ),
                ),
              ),
              Row(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      " \n \t1. Semangkuk Kacang dan Buah  \n \t(Kacang dan buah-buahan yang \n \tmemiliki total karbohidrat cukup \n \ttinggi)",
                      style: TextStyle(
                          fontSize: 25,
          ...
          Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/pahaayam.jpeg"),
                  ),
                ),
              ),
              Row(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "\n \n \t1. Paha Ayam dan Kentang Rebus \n \t(Paha ayam dengan total protein \n \t58g dengan kentang rebus dengan \n \tkarbo 40g)",
                      style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.normal,
                          color: Color.fromARGB(255, 238, 237, 234)),
